...
const ruDictionary: Dictionary = {
  ...
  subscriptionGate: {
    ...
    supportHint:
      "Если хотите оплатить наличными или другим способом, нажмите кнопку ниже — наш администратор свяжется с вами.",
    cashRequestButton: "Наличная оплата (связаться с поддержкой)",
    cashRequestSent:
      "Ваш запрос отправлен. Администратор скоро свяжется с вами.",
